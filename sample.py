...
image_of_dhanush = face_recognition.load_image_file(
    './img/known/dhanush.jpg')
dhanush_face_encoding = face_recognition.face_encodings(image_of_dhanush)[0]
